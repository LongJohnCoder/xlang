...
namespace cdl
{
    ...
    // 2.4.3 Keywords
    //       Note, the full list of keyword strings, keyword rules + the keyword rule itself
    //       were all generated by extractimg all the terminals from the EBNF grammar.  
    //       I've comented out the ones that aren't listed in the doc. Many were not listed
    //       in section 2.4.3 but were used in other rules.
    ...
    struct null_literal : peg::seq< str_null > {};
    ...
    // 4.1 Value types
    //     Note, added Int8 and used Int16/Int64 instead of short/long
